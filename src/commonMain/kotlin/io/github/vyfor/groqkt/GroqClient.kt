...
class GroqClient(
     ...
     */
    suspend fun chat(data: ChatCompletionRequest) = config.client
     ...
     * @return Result<GroqResponse<ChatCompletion>>
     */
    suspend fun chat(block: ChatCompletionRequest.Builder.() -> Unit) = config.client
        .post(ChatCompletionRequest.ENDPOINT) {
            contentType(ContentType.Application.Json)
     ...
     */
    suspend fun chatStreaming(data: ChatCompletionRequest) = config.client
        .post(ChatCompletionRequest.ENDPOINT) {
            contentType(ContentType.Application.Json)
     ...
     * @return GroqStreamingResponse<StreamingChatCompletion>
     */
    suspend fun chatStreaming(block: ChatCompletionRequest.Builder.() -> Unit) = config.client
        .post(ChatCompletionRequest.ENDPOINT) {
            contentType(ContentType.Application.Json)
            setBody(ChatCompletionRequest.Builder().apply {
                block()
     ...
     */
    suspend fun translateAudio(data: AudioTranslationRequest) = config.client
     ...
     * @return Result<GroqResponse<AudioTranslation>>
     */
    suspend fun translateAudio(block: AudioTranslationRequest.Builder.() -> Unit) = config.client
        .submitFormWithBinaryData(
            AudioTranslationRequest.ENDPOINT,
            formData {
     ...
     */
    suspend fun transcribeAudio(data: AudioTranscriptionRequest) = config.client
        .submitFormWithBinaryData(
     ...
     * @return Result<GroqResponse<AudioTranscription>>
     */
    suspend fun transcribeAudio(block: AudioTranscriptionRequest.Builder.() -> Unit) = config.client
        .submitFormWithBinaryData(
            AudioTranscriptionRequest.ENDPOINT,
            formData {
     ...
     */
    suspend fun fetchModel(model: String) = config.client
        .get("models/$model")
        .parse<Model>()
     ...
     * @return Result<GroqResponse<Model>>
     */
    suspend fun fetchModel(model: GroqModel) = config.client
        .get("models/${model.id}")
        .parse<Model>()
     ...
     * @return List<Model>
     */
    suspend fun fetchModels() = config.client
        .get("models")
